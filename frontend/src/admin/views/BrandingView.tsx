...
//
// NOTE FOR THE WORKSTREAM B MERGE: B adds the `needed_by` step to the backend
// registry, which makes it configurable automatically (CONFIGURABLE_STEP_IDS is
// intersected with REGISTRY). Add `{ id: 'needed_by', label: 'When do you need
// them by?' }` to this array at that point. It is omitted today on purpose:
// shipping an id the backend does not yet accept would make the first toggle
// save fail with a 400.
